...
local function getCreateLandings(elevator)
    ...
    -- Physical numbering follows height:
    -- lowest Y = landing 1, highest Y = landing N.
...
-- ============================================================
-- Save configuration
-- Create landing metadata + monitor/speaker mapping
-- ============================================================
...
-- ...
-- FN monitor -> FN speaker
--
-- Each numeric commissioning position is paired with the Create
-- landing at the same Y-sorted position.
-- ============================================================
...
for floor = 1, FLOOR_COUNT do
    ...
    -- --------------------------------------------------------
    -- Store Create identity + presentation + HMI hardware
    -- --------------------------------------------------------
